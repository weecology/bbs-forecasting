...
What we do know comes from a small number of biodiversity studies, where models
are built using data on species occurrence, richness, or community composition
from distinct timeperiods and evaluated on their ability to predict contemporary
[@algar2009; @distler2015] or historic [@maguire2016; @blois2013] patterns.
These studies are a valuable first step, but lack several components that are
