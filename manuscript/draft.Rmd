...
first one, we divided our 32 years of data into 22 years of training data
and retained 10 years of data for evaluation via hindcasting. Second, we used
...
dataset [@jarvis2008] obtained using the R package raster [@hijmans2016].
