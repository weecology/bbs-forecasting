...
[[Note: we sometimes refer to the baselines as "time series models", but (1)
we're also using that name for just auto.arima and (2) the "average" model
doesn't use any time series.  Other possible names: site-level models (as
above); richness-only models; environment-free models...]]
