...
biodiversity forecasts are common in the literature, there is little information
available on how well these forecasts work. Most biodiversity forecasts are not
evaluated in terms of their ability to predict future diversity, fail to account
for uncertainty, and do not use time-series data that captures the actual
dynamics being studied. We compiled a list of ten best practices for forecasting
...
methods (such as species distribution models) can turn spatial data into useful
temporal predictions about biodiversity. This result may call into question the
validity of many high-profile forecasts from the last 15 years. Most of the best
...
approaches. To facilitate the rapid improvement of biodiversity forecasts, we
emphasize the value of specific best practices in making and evaluating
