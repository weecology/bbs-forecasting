...
**[[xxx]].** We used observed richness values from 1982 (the first complete year
of NDVI data) to 2003 for training the models, and data from 2004 to 2013 was
used for testing their performance. We only used BBS routes from the continental
United States (i.e. routes where PRISM data was available), and restricted the
...
dataset included `r numbers$N_runs` transect runs of `r numbers$N_sites` unique
