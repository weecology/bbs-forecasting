...
intervals. Interestingly, this effect was very small for mistnet, which seems to
indicate that its latent variables were already accounting for observer-based
uncertainty. The "naive" model was the only model whose confidence intervals
were too wide (Figure 3), which can be attributed to the rapid rate at which
