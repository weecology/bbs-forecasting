...
actual dynamics being studied. Using hindcasting we made and evaluated XXXX
[number of years * number of models * number of sites] forecasts for breeding
bird species richness at XXX sites throughout North America following best
practices for forecasting. Forecasts were made for up to a decade into the
future. Our results show that while all of the models we evaluated produce
reasonable forecasts, none of them outperforms the simple baseline of long-term
average richness. This means that at present our best forecast for future
richness is simply to assume that it is unchanging. This calls into question the
efficacy of current modeling approaches. Most of the best practices implemented
in this study directly influence the outcome of the forecasts and result in
different conclusions from those made in previous studies. This emphasizes the
importance of following good practice in making ecological forecasts and of
starting to actively make more forecasts in such a way that they can be quickly
