...
results suggest that simple time-series models and baselines should be actively
...
biodiversity should also focus on species composition, since lower-level
...
kinds of rapid changes were difficult for the other time-series models to
...
advantage for simple time-series based approaches.
