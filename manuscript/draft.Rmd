...
those of policymakers; e.g. @ipcc2014], but it is inherently difficult to
evaluate such long-term predictions before the projected biodiversity declines
have occurred. 
...
practices in Box 1 for ecological forecasting. To do this, we combine 32 years
...
across the full 32-year dataset.
...
data and `r numbers$n_gbm[2]` for the observer-corrected data. [[add comma
separators for thousands place]]
