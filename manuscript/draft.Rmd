...
to routes that were sampled during 70% of the years in the training period were
used (i.e., routes with at least 16 annual observations). The resulting dataset
