...
it is important to consider the observation models [Box 1].  When working with
any ecological dataset, there are imperfections in the sampling process that
have the potential to influence results. With large scale surveys and citizen
science datasets, such as the Breeding Bird Survey, these issues are potentially
