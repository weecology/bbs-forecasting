...
>>We added a "future directions" paragraph to address this. Non-directional changes, such as fluctuations from year-to-year, are forecastable in principle, although we agree that they may be harder. Our goal was to evaluate how well this worked for as many time series as possible. We agree that it would be interesting to examine the subset of locations that showed strong directional change and see if those are easier to forecast. We plan on coming back to investigate these questions at a later date.
