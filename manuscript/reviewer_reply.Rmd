...
**We chose not to drop uninformative predictors for two reasons. First, boosted trees are relatively robust to their inclusion ("A working guide to boosted regression trees", Elith et al. 2008), so it seemed unlikely to affect our results. Second, it would have added complexity to the model-fitting procedure, which already involved 500 rounds of cross-validation (one per Monte Carlo sample of the observer effect).**
...
**We have added an equation and clarified the wording here.**
