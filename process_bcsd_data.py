...
def process_data(filename, new_filename):
    ...
    #of all the different ensembles
    ds = ds.mean('projection')

    #Longitude here is from 0 - 360, adjust to -180 - 180
    #Note if any data was outside the western hemisphere this
...
process_data('data/cmip5/bcsd5/Extraction_pr.nc', 'data/cmip5/cmip5_precip.nc')
process_data('data/cmip5/bcsd5/Extraction_tas.nc', 'data/cmip5/cmip5_temp.nc')
